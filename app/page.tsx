...
export default function Home() {
	...
	return (
		...
		>
			...
			<div className="rounded-full drop-shadow-sm bg-gray-100 border border-gray-200 text-lg -mt-5 dark:bg-gray-900 dark:border-gray-800 flex focus-within:border-blue-300 dark:focus-within:border-blue-700 transition-colors">
				<input
				...
				<button
					aria-label="Submit"
					type="submit"
					className="rounded-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition-colors text-white size-10 flex items-center justify-center"
				>
					{isLoading ? (
